...
2. Priorize diárias CEPEA (quando disponíveis) para extrair postura do produtor e liquidez.
3. Notícias marcadas como [CONTEXTO — X dias atrás] têm peso menor que notícias recentes.
4. Seja específico: cite fatos reais, não generalizações.
5. postura_produtor: como o produtor está se comportando (retraído = segurando estoque; ofertante = vendendo).
